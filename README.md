...
![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/f0c7d6eb-9495-4c07-92c8-cdeb0aab59d7/176d522e-dea1-443c-a45d-6bcb6e2ead1b/image.png)

- **웹사이트 디자인**
    - Figma로 웹사이트의 디자인 제작

![image.png](https://prod-files-secure.s3.us-west-2.amazonaws.com/f0c7d6eb-9495-4c07-92c8-cdeb0aab59d7/74c9a73b-9d60-448d-ac34-9dca35c42ecb/256d9327-e9da-48f8-b517-7ebea51d35f4.png)
...
| **수준** | **정의** |
| --- | --- |
| **IM** | **기본적인 알고리즘 개념을 이해하고 있음**
**간단한 반복문과 조건문을 사용하여 기초적인 문제를 해결할 수 있음**
**배열과 문자열 조작의 기본을 알고 있음**
**완전탐색 기법으로 문제를 해결할 수 있음** |
| **A** | **기본 자료구조(스택, 큐, 해시 테이블)를 이해하고 활용할 수 있음**
**정렬 알고리즘의 기본 개념을 알고 있으며 간단한 구현이 가능함**
**재귀 함수의 개념을 이해하고 기본적인 문제에 적용할 수 있음**
**기초적인 그래프 탐색 알고리즘(DFS, BFS)을 이해하고 적용할 수 있음** |
| **A+** | **동적 프로그래밍의 기본 개념을 이해하고 간단한 문제에 적용 가능함**
**이진 탐색, 투 포인터 등의 기법을 활용할 수 있음**
**복잡한 그래프 알고리즘(프림, 다익스트라)을 활용할 수 있음** |
| **B** | **고급 자료구조(세그먼트 트리, 트라이 등)를 이해하고 구현할 수 있음**
**동적 프로그래밍을 다른 여러 기법(비트마스킹 등)과 융합하여 적용할 수 있음**
**문제의 조건을 분석하고 요구되는 시간복잡도를 계산할 수 있음** |
| **C** | **주어진 문제에 따라 요구되는 자료구조, 알고리즘, 시간복잡도를 정확히 파악할 수 있으며, 한정된 언어와 라이브러리만을 활용하여 필요한 자료구조, 알고리즘을 직접 구현, 최적화 할 수 있음** |
